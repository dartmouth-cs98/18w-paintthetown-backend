...
export default {
  ...
  adminData: [{
    ...
    name: process.env.FRIST_NAME_ACACIA,
    ...
    name: process.env.FRIST_NAME_MORGAN,
    ...
    name: process.env.FRIST_NAME_TED,
    ...
    name: process.env.FRIST_NAME_ALEX,
    ...
    name: process.env.FRIST_NAME_WYATT,
